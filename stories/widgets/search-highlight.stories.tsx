...
import { initialValueSearchHighlighting, options } from '../config/initialValues'
  ...
  const createReactEditor = () => () => {
    ...
    return (
      <Slate editor={editor} value={value} onChange={(newValue) => setValue(newValue as SlateDocument)}>
        ...
        <EditablePlugins plugins={plugins} decorate={decorate} decorateDeps={[search]} renderLeafDeps={[search]} />
      </Slate>
    )
  }
