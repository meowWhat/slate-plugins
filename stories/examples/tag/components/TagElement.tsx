...
import { useEditor, useFocused, useSelected } from 'meow-slate-react'
 ...
 */
export const TagElementBase = ({ attributes, children, element, styles, className }: TagElementProps) => {
  ...
  return (
    <div {...attributes} data-slate-value={element.value} className={classNames.root} contentEditable={false}>
