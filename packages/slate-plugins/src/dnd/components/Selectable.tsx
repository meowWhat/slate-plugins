...
import { SelectableProps, SelectableStyleProps, SelectableStyles } from './Selectable.types'

const getClassNames = classNamesFunction<SelectableStyleProps, SelectableStyles>()

const SelectableBase = ({ children, element, className, styles, componentRef, dragIcon }: SelectableProps) => {
  ...
  return (
    <div className={classNames.root} ref={multiRootRef}>
      <div ref={blockRef} className={mergeStyles(classNames.blockAndGutter, classNames.block)}>
        {children}

        {!!dropLine && <div className={classNames.dropLine} contentEditable={false} />}
      </div>
          ...
          <div className={classNames.blockToolbar}>
            <Tippy {...grabberTooltipProps}>
              <div ref={multiDragRef}>
                <button
                  type="button"
                  className={classNames.dragButton + ' slate-drag-button'}
...
export const Selectable = styled<SelectableProps, SelectableStyleProps, SelectableStyles>(
  SelectableBase,
  getSelectableStyles,
  undefined,
  {
